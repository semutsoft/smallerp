...
class Trucking_order extends CI_Controller {
	...
	public function index()
	{
            $data = array(
                ...
                'validasi_active'                   => 'active',
                'btn_monitoring_active'        => 'bg-gray',
                'btn_trucking_active'          => 'bg-orange bg-orange-active',
                'btn_perawatan_active'         => 'bg-gray',
            ...
            $data['LEFT_SECTION']       = $this->parser->parse('validasi_menu_section', $data, true);
