    ...
    function __construct() {
        ...
        $this->table = array(
            ...
            'colomn'    => array(
                ...
                'nama_perusahaan'           => array('id'=>'nama_perusahaan', 'label'=>'Nama Perusahaan', 'key'=>false, 'visible'=>false, 'form'=>array(
                                                    array('id'=>'nama_perusahaan', 'label'=>'Nama Perusahaan','visible'=>true, 'format'=>'LABEL', 'placeholder'=>'', 'required'=>true, 'col_css'=>'col-md-10'))), 
                'nama_perusahaan_lengkap'   => array('id'=>'nama_perusahaan_lengkap', 'label'=>'Nama Lengkap Perusahaan', 'key'=>false, 'visible'=>false, 'form'=>array(
                                                    array('id'=>'nama_perusahaan_lengkap', 'label'=>'Nama Lengkap Perusahaan', 'visible'=>true, 'format'=>'LABEL', 'placeholder'=>'', 'required'=>true, 'col_css'=>'col-md-10'))), 
                'alamat'                    => array('id'=>'alamat', 'label'=>'Alamat', 'key'=>false, 'visible'=>false, 'form'=>array(
                ...
                'telp'                      => array('id'=>'telp', 'label'=>'Telp', 'key'=>false, 'visible'=>false, 'form'=>array(
                ...
                'email'                     => array('id'=>'email', 'label'=>'Email', 'key'=>false, 'visible'=>false, 'form'=>array(
                ...
                'kop'                       => array('id'=>'kop', 'label'=>'KOP', 'key'=>false, 'visible'=>false, 'form'=>array(array('visible'=>false)))
            ),
            'idkey'     => 'id',
            'join'      => array(),
            'where'     => array(),
