...
<head>
  ...
  <title>{WEB_TITLE} | Registration Page</title>
...
<body class="hold-transition register-page" style="background:url({THEMES_PAGE}/assets/images/wallpaper/semutsoft_wallpaper.jpg);background-repeat: no-repeat;  background-size: auto;">
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="{URL_SAVEREGISTER}" method="post">
